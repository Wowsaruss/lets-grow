    ...
    return (
        ...
        >
            ...
            {plant?.determinate !== null ? (
                <h3>DETERMINATE: {plant?.determinate ? 'YES' : 'NO'}</h3>
            ) : null}
            {plant?.seed_depth ? (
                <h3>SEED DEPTH: {plant?.seed_depth}</h3>
            ) : null}
            {plant?.days_to_germination ? (
                <h3>DAYS TO GERMINATION: {plant?.days_to_germination}</h3>
            ) : null}
            {plant?.germination_temps_f ? (
                <h3>GERMINATION TEMPERATURES: {plant?.germination_temps_f}</h3>
            ) : null}
            ...
            {plant?.fall_start_indoors ? (
                <h3>START INDOORS (FALL): {plant?.fall_start_indoors}</h3>
            ) : null}
            {plant?.fall_transplant ? (
                <h3>TRANSPLANT (FALL): {plant?.fall_transplant}</h3>
            ) : null}
            {plant?.fall_start_outdoors ? (
                <h3>START OUTDOORS (FALL): {plant?.fall_start_outdoors}</h3>
            ) : null}
